...
class LogTextTest {
    ...
    @Test void stackTraceIsCompactedToHeadersFirstFramesAndCauses() {
    ...
    @Test void longMessagesAreTruncatedOnCodePointsAndNewlinesFlattened() {
    ...
    @Test void fitDropsOldestLinesFirstAndFailsOnlyWhenNothingFits() {
    ...
    @Test void dateMarkersAppearOnlyWhenTheDayChanges() {
